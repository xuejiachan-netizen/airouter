...
CREATE TABLE IF NOT EXISTS `api_key` (
                                         ...
                                         `keyValue`     VARCHAR(255) DEFAULT NULL COMMENT 'API Key值（sk-xxx格式）',
    `keyName`      VARCHAR(255) DEFAULT NULL COMMENT 'Key名称/备注',
    `status`       VARCHAR(255) DEFAULT NULL COMMENT '状态：active/inactive/revoked',
    `totalTokens`  BIGINT       DEFAULT NULL COMMENT '已使用Token总数',
